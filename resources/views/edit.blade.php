...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">EDITAR CURSO - {{$curso->titulo}}</div>

                <div class="card-body">
                    <form method="POST" action="/crudpi/public/cursos/atualizar/{{$curso->id}}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                        ...
                        <label for="formFile" class="col-md-4 col-form-label text-md-end">Escolha sua imagem</label>
                            <div class="col-md-6">
                            <input class="form-control" type="file" id="imagem" required>
                            </div>
                        </div>

                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary" action="{{url('/cursos')}}">
                                    Editar curso
                                </button>
